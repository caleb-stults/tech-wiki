...
1. **Configure MakeMKV:**
    ...
    * *This is the screen for setting up the Java environment in MakeMKV* ![This is the screen for setting up the Java environment in MakeMKV](../../images/makemkv-java.PNG)
