...
1. Make them persistent on reboot:

```bash
    sudo apt install iptables-persistent
```

1. Then make a static route for the emby tailscale IP to point to this server you ran these commands on.
